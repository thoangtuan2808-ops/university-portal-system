document.addEventListener('DOMContentLoaded', () => {
    ...
    // ==========================================
    // 1. AUTH GUARD - CHỐT CHẶN BẢO VỆ TRANG CỦA GIẢNG VIÊN
    // ==========================================
    ...
    // Nếu không có thẻ bài, hoặc không phải Giảng Viên (Role 2) -> Đá văng!
    if (!token || roleId !== "2") {
    ...
    const teacherIdEl = document.querySelector(".teacher-id");
    
    // Thay thế tên giả định "Nguyễn Văn A" bằng tài khoản thật
    if (teacherNameEl) teacherNameEl.textContent = userName; 
    if (teacherIdEl) teacherIdEl.textContent = "Tài khoản: " + userName;
